    ...
    ui(new Ui::coliopUi)
{
    ...
    connect(ui->actionNew_Coliop4_Window,  &QAction::triggered, this, &ColiopUi::on_actionNewColiopWindow );
...
void ColiopUi::on_actionNewColiopWindow() {
    ...
    if (runningOs == "windows" ) {
         runProg = "\""+progPath+"/Coliop4.exe\"";
    } else if (runningOs == "osx" || runningOs == "macos"  )  {
         runProg = "open -n /Applications/Cmpl/bin/Coliop4.app";
    } else  {
        runProg = "\""+progPath+"/../Coliop\"";
   }
...
void ColiopUi::on_cmplHelp()
{
    ...
    if (runningOs == "windows" ) {
        ...
        runProg = "/Applications/Cmpl/bin/manual";
...
void ColiopUi::cmplList() {
    ...
    if (!problem->getProblemName().isEmpty() && problem->getActiveCmplIndex()==0) {
        ...
        rx.setPattern("%data([ a-zA-Z0-9\-_\\\\./]*)[\:\n\r]{1,}");
        ...
        rx.setPattern("include\\s*\\(\"([a-zA-Z0-9\-_\\\\./]*)\"\\)");
        pos = 0;
        while ((pos = rx.indexIn(actCmplCode, pos)) != -1) {
