...
void cfResult::standardReport() {
    ...
    for (int n=0; n < nrOfSolutions(); n++)   {
        ...
        cout << setw(20) << left <<  "Solution nr.: " << n+1 << endl;
        cout << setw(20) << left <<  "Objective name : " << objectiveName() << endl;
        cout << setw(20) << left <<  "Objective value : " << objectiveValue(n) << " (" << objectiveSense() << "!)" << endl;

        cout <<endl;

        cout << setw(20) << left <<  "Variables " << endl;
        cout << setw(20) << left <<  "Nr. of variables:" << nrOfVariables() << endl;
        ...
        for (long i=0; i < nrOfVariables(); i++) {
             cout << setw(20) << setprecision(2) << fixed << left <<  varName(i);
             cout << setw(5) << setprecision(2) << fixed << right << varType(i);
             cout << setw(20) << setprecision(2) << fixed << right << varActivity(n,i);
             if (varHasLowerBound(i))
                    cout << setw(20) << setprecision(2) << fixed << right << varLowerBound(i);
             else
                    cout << setw(20)  << right<< "-Infinity";
             if (varHasUpperBound(i))
                    cout << setw(20) << setprecision(2) << fixed << right << varUpperBound(i);
             else
                    cout << setw(20)  << right<< "Infinity";
             if (varHasMarginal(n,i))
                    cout << setw(20) << setprecision(2) << fixed << right<< varMarginal(n,i);
             else
                    cout << setw(20) << right << "-" ;
             cout << endl;
         }
        ...
        cout << setw(20) << left <<  "Constraints " << endl;
        cout << setw(20) << left <<  "Nr. of constraints:" << nrOfConstraints() << endl;
        ...
        for (long i=0; i < nrOfConstraints(); i++) {
             cout << setw(20) << setprecision(2) << fixed << left <<  constraintName(i);
             cout << setw(5) << setprecision(2) << fixed << right << constraintType(i);
             cout << setw(20) << setprecision(2) << fixed << right<< constraintActivity(n,i);
             if (constraintHasLowerBound(i))
                    cout << setw(20) << setprecision(2) << fixed << right << constraintLowerBound(i);
             else
                    cout << setw(20) << right<< "-Infinity";
             if (constraintHasUpperBound(i))
                    cout << setw(20) << setprecision(2) << fixed << right << constraintUpperBound(i);
             else
                    cout << setw(20) << right<< "Infinity";
             if (constraintHasMarginal(n,i))
                    cout << setw(20) << setprecision(2) << fixed << right << constraintMarginal(n,i);
             else
                    cout << setw(20) << right << "-";
             cout <<endl;
         }
...
bool cfResult::writeCsv() {
    ...
    csvFH << "eCMPL csv export" << endl << endl;
...
void cfResult::getSolverMessages() {
    ...
    cout << setw(20) << left << "Solver failed" <<endl;
    cout << setw(20) << left << "General status: " << generalStatus()<< endl;
    cout << setw(20) << left << "Problem : " << instanceName() << endl;
    //cout << setw(20) << left << "ServiceName" << serviceName() << endl;
    cout << setw(20) << left << "SolverName" << solverName() << endl;
    cout << setw(20) << left << "Solver message: " << solverMessage() << endl;
    cout << setw(20) << left << "Nr. of Solutions: " << nrOfSolutions() << endl;
