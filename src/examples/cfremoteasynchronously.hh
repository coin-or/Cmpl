...
#ifndef CFREMOTEASYNCHRONOUSLY_H
#define CFREMOTEASYNCHRONOUSLY_H
...
class cFRemoteAsynchronously
{
public:
    cFRemoteAsynchronously() {}

    void runService(string pName, string serviceName);
private:
    eCmplIO myProblemIo;
};

#endif // CFREMOTEASYNCHRONOUSLY_H
