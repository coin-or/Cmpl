...
namespace cmpl
{
	...
	public:
		 ...
		 * constructor
		 */
		inline IntFuncTermBeg(Main *m): IntFuncBase(m) {}
	...
	public:
		 ...
		 * constructor
		 */
		inline IntFuncTermNegFak(Main *m): IntFuncBase(m) {}
	...
	public:
		 ...
		 * constructor
		 */
		inline IntFuncTermVar(Main *m): IntFuncBase(m) {}
	...
	public:
		 ...
		 * constructor
		 */
		inline IntFuncTermVarFree(Main *m): IntFuncTermVar(m) {}
	...
	public:
		 ...
		 * constructor
		 */
		inline IntFuncTermEnd(Main *m): IntFuncBase(m) {}
