...
#define DST_NAME_LEN	( glvar->args->freeMps() ? 100 : 9 )  /* 1.1.2 stegger - max lenght parameter for names */
...
#define SYM_NAME_LEN	101		/* Maximale Symbolnamenlaenge + 1 */

#define ZC_NAME_LEN		100		/* Max. Laenge Namen waehrend Verarbeitung */
...
#define FILE_PATH_BUF_LEN	5000	/* 1.1.3 TS: Puffergroesse fuer Dateinamen/Pfadnamen */
...
#define LINE_NAME_DEF	"line$1$"	/* Default fuer Zeilenname */
...
#define LINE_NANE_CONCAT_2		""		/* Verkettung fuer Zeilennamen: Trennung zwischen Praefix und Laufkonstantenersetzung */
#define LINE_NANE_CONCAT_3		","		/* Verkettung fuer Zeilennamen: Trennung zwischen den Laufkonstantenersetzungen */
...
/* definition of the names for automatic subsymbols */
#define SUB_AUTO_SOLUTION		"solution"			/* vector of solutions for a cmpl problem */
#define SUB_AUTO_OBJECTIVE		"objective"			/* objective value for a cmpl problem */
#define SUB_AUTO_VARIABLES		"vars"				/* variables in a solution for a cmpl problem */
#define SUB_AUTO_CONSTRAINTS	"constraints"		/* constraints in a solution for a cmpl problem */
#define SUB_AUTO_VC_NAME		"name"				/* name of variables or constraints in a cmpl problem */
#define SUB_AUTO_VC_NUMBER		"number"			/* current number of variables or constraints in a cmpl problem */
#define SUB_AUTO_VC_ACTIVITY	"activity"			/* result value for variables or constraints in a solution of a cmpl problem */
#define SUB_AUTO_VC_MARGINAL	"marginal"			/* result marginal for variables or constraints in a solution of a cmpl problem */
#define SUB_AUTO_VCRES_FLAT		"_flat"				/* all result values for variables or constraints as a flat vector */
