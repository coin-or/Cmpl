...
namespace cmpl
{
	...
	/**
	 * The <code>IntFuncConstructTupelsetFreeIndRev</code> class is used for
	 * construct a new tupelset from one value with setting for <code>_freeIndRev</code> and push it on the value stack.
	 */
	class IntFuncConstructTupelsetFreeIndRev: public IntFuncBase
	{
	public:
		/**
		 * constructor
		 */
		inline IntFuncConstructTupelsetFreeIndRev(CmplCore *m): IntFuncBase(m) {}
	...
	/**
	 * The <code>IntFuncDisaggrTupelRev</code> class is used for
	 * disaggregate a tupel and push its parts in reverse order on the value stack.
	 */
	class IntFuncDisaggrTupelRev: public IntFuncBase
	{
	public:
		/**
		 * constructor
		 */
		inline IntFuncDisaggrTupelRev(CmplCore *m): IntFuncBase(m) {}
