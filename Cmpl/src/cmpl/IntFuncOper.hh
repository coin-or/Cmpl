...
namespace cmpl
{
	...
	protected:
		...
		// within Tupelset::constructFromIntersection() the function fset_op() is called
		friend void Tupelset::constructFromIntersection(CmplCore *glvar, IntFuncNumOp *funcNumOp, val_str *vp1, val_str *vp2, int mode, bool *pat, bool r1val, bool glmem, val_str *tup);
		 ...
		 */
		void tupel_op(int op, val_str v1, val_str v2);
	};
	...
	private:
		/**
		 * compares two val_str values.
		 * @param op	compare operation
		 * @param v1	first value
		 * @param v2	second value
		 * @return		compare result
		 */
		bool fcmp_val(int op, val_str *val1, val_str *val2);
		...
		/**
		 * compares two tupel or tupelset values.
		 * @param op	compare operation (only EQ, EQ2)
		 * @param tup1	first value
		 * @param tup2	second value
		 * @return		compare result
		 */
		bool fcmp_tup(int op, val_str *tup1, val_str *tup2);
	};
