...
namespace cmpl
{
	...
	private:
		 ...
		 */
        void make_test_var(symbol_str *sym_p, int mi, var_str **vpp, int symnum);

        /**
         * set the pointer tvp->tv_varp anew for matching symbols
         * @param tvp       structure with pointer to set
         * @param symnum    only symbols with this symbol number
         * @param arr_p     array with the info to point to
         */
        void set_renew_tv_varp(struct term_var_str::tv_str *tvp, int symnum, array_str *arr_p);
