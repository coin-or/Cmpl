...
namespace cmplUtil {
    ...
    void ArgError::usage(int mode) {
        ...
        uOut << " -data <cmplDataFile>    : reads a cmplDataFile " << endl;
        ...
        uOut << "                           possible options: glpk, cbc, scip,  gurobi, cplex" << endl;
        ...
        uOut << " -solution [<File>]      : optimization results in CmplSolution XML format " << endl;
        uOut << " -solutionCsv [<File>]   : optimization results in CSV format " << endl;
        uOut << " -solutionAscii [<File>] : optimization results in ASCII format " << endl;
