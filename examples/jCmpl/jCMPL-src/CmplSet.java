...
public class CmplSet
{
    ...
    public int len() throws CmplException
    {
        ...
        else if(_type == 3)
        {
            if ( (Integer)_valueArray[1]>0) {
                _count = (int) (Math.ceil((Integer)_valueArray[2]-(Integer)_valueArray[0]+1) / Math.abs((Integer)_valueArray[1]));
            } else {
                _count = (int) (Math.ceil((Integer)_valueArray[0]-(Integer)_valueArray[2]-1) / Math.abs((Integer)_valueArray[1]));
            }
        }
        return  _count;
    }
  ...
  /**
     ...
     * @return List|Array of the indexing entries
     */
